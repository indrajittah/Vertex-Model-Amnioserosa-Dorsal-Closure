...
class Simple2DModel
	...
	virtual void setCellPreferencesUniform(Dscalar A0, Dscalar P0) = 0;
	virtual void setModuliUniform(Dscalar newKA, Dscalar newKP) = 0;
        virtual Dscalar reportavgA() = 0;
	virtual Dscalar reportavgP() = 0;
        //!reporting function (remove later...)
