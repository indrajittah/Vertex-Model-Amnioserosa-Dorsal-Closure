...
class Simple2DCell : public Simple2DModel
	...
	//!Set cell area and perimeter preferences according to your choice
	void setCellPreferencespoly(Dscalar A0, Dscalar MEANP0, Dscalar STDP0, Dscalar STDA0);
...
//        virtual GPUArray<Dscalar2> & returnstress_ncells(){return stress_ncells;};
	...
	//! AreaPerimeter of cells
	GPUArray<Dscalar2> AreaPeri;
	//! AreaPerimeter preference of cells
	GPUArray<Dscalar2> AreaPeriPreferences;
	//!Area Perimeter modulii 
	GPUArray<Dscalar2> Moduli;
//	GPUArray<Dscalar> stress_ncells;
...
//        GPUArray<int> cellVertices;
	...
	Dscalar2 reportVarAP_min_model();
	//! Report Ingrss id of cell below some thresold 
	Dscalar reportcellingressid();
        Dscalar reportcellingressbelowthreshold_id();
	Dscalar reportcellingress_according_ti_Cortical_tension_id();
        //! Report the mean value of the perimeter
        Dscalar reportMeanP();
        Dscalar reportMeanA();
        Dscalar reportMeanP_min_model();
	Dscalar reportMeanA_min_model();
	Dscalar NormalStress();
	Dscalar NormalInterstress();
	Dscalar HydrostaticPressure();
	//Dscalar Return_Normal_stress_due_to_its_neighborcells();
	vector<double> Return_Normal_stress_due_to_its_neighborcells();
	vector<double> Return_Individual_Cell_Line_Tension();
//	void Return_Normal_stress_due_to_its_neighborcells(std::vector<int>& v);
	vector<double> Return_Linetension();
